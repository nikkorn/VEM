...
public class ChunkFactory {
	...
	public static Chunk createNewChunk(WorldGenerator generator, short x, short y) {
		...
		Placements placements = generateChunkPlacements(generator, tiles, x, y);
	 ...
	 */
	private static Placements generateChunkPlacements(WorldGenerator worldGenerator, TileType[][] tiles, int x, int y) {
		...
		for (short tileX = 0; tileX < Constants.WORLD_CHUNK_SIZE; tileX++) {
			for (short tileY = 0; tileY < Constants.WORLD_CHUNK_SIZE; tileY++) {
				...
				if (placementType != PlacementType.NONE) {
					// Create and add our newly generated placement.
	 ...
	 * @param x The placement x position within its parent chunk.
	 * @param y The placement y position within its parent chunk.
